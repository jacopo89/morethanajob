...
import {useForceNotification, useSetNotificationUrl} from "./useNotifications";
...
export default function usePushNotifications() {
    ...
    const [response, setNotificationUrlHandler] = useSetNotificationUrl();

    const [responseNotification, forceNotificationHandler] = useForceNotification();
    ...
    useEffect(() => {
        if (pushNotificationSupported) {
            ...
            registerServiceWorker().then(() => {
                ...
                setLoading(false);
            }).catch((reason)=>console.log("Service worker not registered for reason", reason));
        }
    }, []);
    ...
    const onClickSendSubscriptionToPushServer = () => {
        ...
        setNotificationUrlHandler(formData, {successCallback: successCallback});
        /*http
    ...
    const onClickSendNotification = async () => {
        ...
        forceNotificationHandler(formData, {successCallback: successCallback});
