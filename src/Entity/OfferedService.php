...
class OfferedService
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Service", inversedBy="offeredServices")
     * @ORM\JoinColumn(nullable=false)
     */
    private $service;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\User", inversedBy="offeredServicesRelations")
     * @ORM\JoinColumn(nullable=false)
     */
    private $user;
